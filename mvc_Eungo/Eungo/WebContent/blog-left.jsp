			...
			<div class="row">
				...
				<div class="blog-lst col-md-9">
					<section class="post">
						...
						<div class="row">
							...
							<div class="col-sm-6 right">
								<p class="date-comments">
									<a href="single.jsp"><i class="fa fa-calendar-o"></i> June
										20, 2013</a> <a href="single.jsp"><i class="fa fa-comment-o"></i>
										8 Comments</a>
								</p>
							</div>
						</div>
						<div class="image wow fadeInLeft animated">
							<a href="single.jsp"> <img src="assets/img/blog2.jpg"
						...
						<p class="read-more">
							<a href="single.jsp" class="btn btn-default btn-border">Continue
								reading</a>
						</p>
					</section>
					...
					<section class="post">
						...
						<div class="image wow fadeInLeft animated">
							<a href="single.jsp"> <img src="assets/img/blog1.jpg"
								class="img-responsive" alt="Example blog post alt">
							</a>
						</div>
						<p class="intro">Pellentesque habitant morbi tristique
