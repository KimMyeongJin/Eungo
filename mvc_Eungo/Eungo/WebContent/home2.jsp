...
<link href="//fonts.googleapis.com/css?family=Quicksand:300,400,500,700"
	rel="stylesheet">
<link href="/build/css/kmong-40396f5b83.master_desktop.css"
	rel="stylesheet">
<link href="css/kmong_desktop_v2.css" rel="stylesheet">
...
<body>
	<!-- banner-inner -->
	<div id="demo-1"
		data-zs-src='["images/1.jpg", "images/2.jpg","images/3.jpg", "images/4.jpg"]'
				...
				<div class="row populor_category_grids mt-5">
					<div class="col-md-3 category_grid">
						<div class="view view-tenth">
							...
							<div class="mask">
								<a href="#"> <img src="images/p1.jpg" class="img-fluid"
									alt="">
								</a>
							</div>
						</div>
					...
					<div class="col-md-3 category_grid">
						<div class="view view1 view-tenth">
							...
							<div class="mask">
								<a href="#"> <img src="images/p2.jpg" class="img-fluid"
									alt="">
								</a>
							</div>
						</div>
					...
					<div class="col-md-3 category_grid">
						<div class="view view2 view-tenth">
							...
							<div class="mask">
								<a href="#"> <img src="images/p3.jpg" class="img-fluid"
									alt="">
								</a>
							</div>
						</div>
					...
					<div class="col-md-3 category_grid">
						<div class="view view3 view-tenth">
							...
							<div class="mask">
								<a href="#"> <img src="images/p4.jpg" class="img-fluid"
									alt="">
								</a>
							</div>
						</div>
	...
	<section class="banner-bottom-wthree pb-lg-5 pb-md-4 pb-3">
		<div class="container">
			<div class="inner-sec-w3ls py-lg-5  py-3">
				<h3 class="tittle text-center mb-lg-4 mb-3">
					<span>Some Info</span>최신글/인기글
				</h3>
				<div class="tabs mt-5">
					<ul class="nav nav-pills my-4" id="pills-tab" role="tablist">
						<li class="nav-item"><a class="nav-link active"
							id="pills-home-tab" data-toggle="pill" href="#pills-home"
							role="tab" aria-controls="pills-home" aria-selected="true">인기글</a>
						</li>
						<li class="nav-item"><a class="nav-link"
							id="pills-profile-tab" data-toggle="pill" href="#pills-profile"
							role="tab" aria-controls="pills-profile" aria-selected="false">최신글</a>
						</li>
									...
									<div class="col-lg-8 text-info-sec">
										...
										<div class="job-post-main row">
											<div class="col-md-9 job-post-info text-left">
												...
												<div class="job-single-sec">
													...
													<ul class="job-list-info d-flex">
														...
														<li><i class="fas fa-dollar-sign"></i> 300000 -
															500000 / Annum</li>
													</ul>
												</div>
												<div class="clearfix"></div>
											...
											<div class="col-md-3 job-single-time text-right">
												<span class="job-time"> <i class="far fa-heart"></i>
													Full Time
												</span> <a href="#" class="aply-btn ">Appy Now</a>
											</div>
										</div>
										<!--//job1-->
										<!--/job2-->
										...
										<div class="job-post-main row my-3">
											<div class="col-md-9 job-post-info text-left">
												...
												<div class="job-single-sec">
													<h4>
														<a href="#"> Regional Sales Manager</a>
													</h4>
										...
										<div class="job-post-main row">
											<div class="col-md-9 job-post-info text-left">
												...
												<div class="job-single-sec">
													...
													<p class="my-2">Company Name goes here</p>
													<ul class="job-list-info d-flex">
														<li><i class="fas fa-briefcase"></i> Chicago</li>
														<li><i class="fas fa-map-marker-alt"></i> California</li>
														<li><i class="fas fa-dollar-sign"></i> 300000 -
															500000 / Annum</li>
													</ul>
										...
										<div class="job-post-main row mt-3">
											<div class="col-md-9 job-post-info text-left">
												...
												<div class="job-single-sec">
													<h4>
														<a href="#"> Marketing Director</a>
													</h4>
													<p class="my-2">Technology Management Consulting</p>
													<ul class="job-list-info d-flex">
														<li><i class="fas fa-briefcase"></i> Rennes</li>
														<li><i class="fas fa-map-marker-alt"></i> France</li>
														<li><i class="fas fa-dollar-sign"></i> 300000 -
															500000 / Annum</li>
													</ul>
												</div>
										...
										<div class="job-post-main row my-3">
											<div class="col-md-9 job-post-info text-left">
												...
												<div class="job-single-sec">
													<h4>
														<a href="#"> Content Writer and Speaker</a>
													</h4>
													<p class="my-2">Company Name goes here</p>
													<ul class="job-list-info d-flex">
														<li><i class="fas fa-briefcase"></i> Comera</li>
														<li><i class="fas fa-map-marker-alt"></i> California</li>
														<li><i class="fas fa-dollar-sign"></i> 200000 -
															100000 / Annum</li>
													</ul>
												</div>
												<div class="clearfix"></div>
							...
							<div class="col-xs-2 padding-right-5">
								...
								<div class="row">
									<div class="col-xs-12">
										<div class="container">
											<div class="col-xs-12">
												<div class="left-menu-title-wrapper margin-top-20 padding-side-20">
													...
													<div class="row">
														<div class="col-xs-12">
															...
															<ul class="margin-none list-unstyled">
																...
																<div class="toggle-list" style="display: none; margin-left:15px; font-size:13px;">
																		<div class="third-category-wrapper" style="fontsize :13px;">
																			<div class="category-list-item third-category ">
																				<a class="plain"
																					href="#" style="color:black">전체</a>
																...
																<script>
																	...
																	$(toggleBtn).unbind('click').click(function(e) {
																		...
																		if ($(this).children(open).css('display') === 'inline-block') {
																			$(this).children(open).css('display', 'none');
																			$(this).children(close).css('display', 'inline-block');
																		} else {
						...
						<td id="tb2" style="width: 75%;">
							...
							<div class="inner-sec-w3ls py-lg-5  py-3">
								...
								<div class="row mt-5">
									...
									<div class="card-deck">
										<div class="card">
											<img src="images/g1.jpg" alt="Card image cap"
										...
										<div class="card">
											<img src="images/g2.jpg" alt="Card image cap"
												class="img-fluid card-img-top">
											<div class="card-body">
										...
										<div class="card">
											<img src="images/g3.jpg" alt="Card image cap"
												class="img-fluid card-img-top">
											<div class="card-body">
