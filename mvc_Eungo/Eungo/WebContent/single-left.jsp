				...
				<div class="blog-asside-right col-md-3">
					<div
						...
						<div class="panel-body text-widget">
							<p>Improved own provided blessing may peculiar domestic.
								Sight house has sex never. No visited raising gravity outward
					...
					<div class="panel sidebar-menu wow  fadeInRight animated">
						...
						<div class="panel-body">
							<ul class="tag-cloud">
								<li><a href="#"><i class="fa fa-tags"></i> jsp5</a></li>
				...
				<div class="blog-lst col-md-9 p0">
					<section id="id-100" class="post single">
							...
							<div class="row wow fadeInRight animated">
								<div class="col-sm-6">
									<p class="author-category">
										By <a href="#">John Snow</a> in <a href="blog.jsp">Webdesign</a>
									</p>
								</div>
								<div class="col-sm-6 right">
									<p class="date-comments">
										<a href="single.jsp"><i class="fa fa-calendar-o"></i>
											June 20, 2013</a> <a href="single.jsp"><i
						...
						<div id="post-content"
							...
							<p>
								<img src="assets/img/blog10.jpg" class="img-responsive"
									alt="Example blog post alt">
							</p>
							...
							<p>Pellentesque habitant morbi tristique senectus et netus et
								...
								enim in turpis pulvinar facilisis. Ut felis. Praesent dapibus,
						...
						<div class="post-footer single wow fadeInBottum animated">
							<ul class="pager">
								<li class="previous"><a href="#"><i class=""></i>←
										Older </a></li>
								<li class="next disabled"><a href="#">Newer →<i
										class=""></i>
								</a></li>
							</ul>
						</div>
					...
					<section id="comments" class="comments wow fadeInRight animated">
						...
						<div class="row comment">
							<div class="col-sm-3 col-md-2 text-center-xs">
								<p>
									<img src="assets/img/client-face1.png"
						...
						<div class="row comment last">
							...
							<div class="col-sm-3 col-md-2 text-center-xs">
								<p>
									<img src="assets/img/client-face2.png"
										class="img-responsive img-circle" alt="">
								</p>
							</div>
					...
					<section id="comment-form" class="add-comments">
						<h4 class="text-uppercase wow fadeInLeft animated">Leave
							comment</h4>
						<form>
							...
							<div class="row wow fadeInLeft animated">
								<div class="col-sm-6">
									<div class="form-group">
										...
										</label> <input class="form-control" id="email" type="text">
									</div>
								</div>
							</div>
