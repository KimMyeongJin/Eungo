...
public class PriceDAO {
	...
	public int modify(PriceVO price) {
		String SQL = "UPDATE price SET standard_price = ?, standard_title = ?, standard_content = ?, standard_modify = ?, standard_time = ?, deluxe_price = ?, deluxe_title = ?, deluxe_content = ?, deluxe_modify = ?, deluxe_time = ?, premium_price = ?, premium_title = ?, premium_content = ?, premium_modify = ?, premium_time = ? WHERE lnumber = ?";
		Connection conn = DBManager.getConnection();
		try {
			pstmt = conn.prepareStatement(SQL);			
			pstmt.setString(1, price.getStandard_price());
			pstmt.setString(2, price.getStandard_title());
			pstmt.setString(3, price.getStandard_content());
			pstmt.setInt(4, price.getStandard_modify());
			pstmt.setString(5, price.getStandard_time());
			pstmt.setString(6, price.getDeluxe_price());
			pstmt.setString(7, price.getDeluxe_title());
			pstmt.setString(8, price.getDeluxe_content());
			pstmt.setInt(9, price.getDeluxe_modify());
			pstmt.setString(10, price.getDeluxe_time());
			pstmt.setString(11, price.getPremium_price());
			pstmt.setString(12, price.getPremium_title());
			pstmt.setString(13, price.getPremium_content());
			pstmt.setInt(14, price.getPremium_modify());
			pstmt.setString(15, price.getPremium_time());
			pstmt.setInt(16, price.getLnumber());
			pstmt.executeUpdate();
			return 1;
		} catch (Exception e) {
			e.printStackTrace();
