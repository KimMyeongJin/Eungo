...
public class EmailSendAction implements Action{
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int emailChecked = dao.select_emailcheck(email);
		if(emailChecked == 1){
		...
		String from = "eungo5600@gmail.com";
		String to = email;
		...
		String content = "다음 링크에 접속하여 이메일 인증을 진행해주세요. "
				+ "<a href='"+host+"gmail/emailCheckAction.jsp?code="+code+"&email="+to+"'>이메일 인증하기</a>";
