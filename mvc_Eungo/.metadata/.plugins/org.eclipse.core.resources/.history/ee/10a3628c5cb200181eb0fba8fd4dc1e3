                    ...
                    <div class="login px-4 mx-auto mw-100">
                        ...
                        <form action="<%=request.getContextPath()%>/member?cmd=member_join" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="phonenumber" id="validationDefault01" required>
                            </div>
                            
                            <div class="form-group">
                                <label>Gender</label>
                                <input type="text" class="form-control" name="gender" id="validationDefault01" required>
                            </div>
                            
                            <div class="form-group">
                                <label>Birthday</label>
                                <input type="text" class="form-control" name="birthday" id="validationDefault01" required>
                            </div>
